...
import org.vaadin.addons.converters.SuggestionCaptionConverter;
import org.vaadin.addons.converters.SuggestionValueConverter;
import org.vaadin.addons.generators.SuggestionGenerator;
import org.vaadin.addons.generators.SyncSuggestionGenerator;
 ...
 * <p>
 * Suggestions are generated by a {@link SyncSuggestionGenerator} or a {@link
 * SuggestionGenerator} and can be any type. Suggestions are transferred to
 * client as a list of caption-value pairs. Caption is the visible HTML part.
 * Value is to be set as text field value when suggestion is selected. {@link
 * SuggestionCaptionConverter} is responsible for translating caption while
 * {@link SuggestionValueConverter} translates the value.
 *
 * @param <T>
 *         Type of the data to be generated. Can be the type of any Java
 *         object.
 * @see SuggestionGenerator
 * @see SyncSuggestionGenerator
...
public class AutocompleteExtension<T> extends AbstractExtension {
    ...
    /**
     * Sets an asynchronous suggestion generator for this extension. This
     * generator is used for creating suggestions when user types into the text
     * field.
     *
     * @param suggestionGenerator
     *         Asynchronous generator to be set.
     */
    ...
    /**
     * Sets a synchronous suggestion generator for this extension. This
     * generator is used for creating suggestions when user types into the text
     * field.
     *
     * @param suggestionGenerator
     *         Synchronous generator to be set.
     */
    public void setSuggestionGenerator(
            SyncSuggestionGenerator<T> suggestionGenerator) {
        setSuggestionGenerator((SuggestionGenerator<T>) suggestionGenerator);
    }

    /**
     * Sets an asynchronous suggestion generator and converters for this
     * extension.
     *
     * @param suggestionGenerator
     *         Asynchronous generator for generating suggestions for user
     *         input.
    ...
    /**
     * Sets a synchronous suggestion generator and converters for this
     * extension.
     *
     * @param suggestionGenerator
     *         Synchronous generator for generating suggestions for user input.
     * @param valueConverter
     *         Converter to translate suggestion to value to be sat as text
     *         value when suggestion is selected.
     * @param captionConverter
    ...
    public void setSuggestionGenerator(
            ...
            SuggestionCaptionConverter<T> captionConverter) {
        setSuggestionGenerator((SuggestionGenerator<T>) suggestionGenerator,
                valueConverter, captionConverter);
    }
